...
public class ControladorCliente implements ControladorPersona {
     ...
     * @return verdadero o falso, dependiendo de si se pudo o no agregar la información a la BD.
     * @throws SQLException en caso de la conexión con la BD no haya podido ser establecida.
     */
    @Override
    ...
    /**
     *Busca en la BD la tupla que coincida con el identificador que se le pasa y devuelve
     * toda la información de la tupla que está almacenada en la BD.
     * @param idCliente es el identificador del objeto a ser encontrado en la BD.
     * @return el objeto Cliente con la información Correspondiente.
     * @throws SQLException en caso de que no se establezca la conexión con la BD.
     */
    ...
    /**
     *Método que elimina la información de un cliente que está almacenado en la BD.
    ...
    /**
     *Método que obtiene la información de varios clientes en la BD que coincidan con el nombre.
     * @param nombrePersona que será buscado en la BD.
     * @return una lista con la información de los objetos que coincidan en la BD.
     * @throws SQLException en caso de que no se establezca la conexión con la BD.
     */
    @Override
    ...
    /**
     *Busca la información de los clientes en la BD y devuelve un objeto con la información
     * del cliente que coincida con el nombre en la BD.
   ...
   /**
     * Función que obtiene la información de todos los clientes que se encuentran en la BD.
     *
